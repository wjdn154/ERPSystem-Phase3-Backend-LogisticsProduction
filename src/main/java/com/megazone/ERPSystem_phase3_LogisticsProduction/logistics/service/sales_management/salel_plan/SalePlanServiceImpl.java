...
import com.megazone.ERPSystem_phase3_LogisticsProduction.logistics.model.sales_management.SalePlanDetail;
...
import com.megazone.ERPSystem_phase3_LogisticsProduction.logistics.model.sales_management.dto.sale_plan.SalePlanResponseDetailDto.SalePlanItemDetailDto;
        ...
        try {
            ...
            integratedService.recentActivitySave(
                    RecentActivityEntryDTO.create(
                            "신규 판매계획 등록 : " + salePlan.getDate() + " -" + salePlan.getId(),
