...
import com.megazone.ERPSystem_phase3_LogisticsProduction.hr.model.basic_information_management.employee.Department;
...
import com.megazone.ERPSystem_phase3_LogisticsProduction.production.model.production_schedule.common_scheduling.ProductionRequest;
...
import com.megazone.ERPSystem_phase3_LogisticsProduction.production.repository.production_schedule.common_scheduling.production_request.ProductionRequestsRepository;
import com.megazone.ERPSystem_phase3_LogisticsProduction.production.service.production_schedule.planning.mps.MpsService;
...
public class ProductionRequestServiceImpl implements ProductionRequestService {
    ...
    public boolean isDuplicateRequest(ProductionRequestDetailDTO dto) {
    ...
    @Override
    @Transactional(readOnly = true)
    public void validateRelatedEntities(ProductionRequestDetailDTO dto) {
    ...
    public ProductionRequestDetailDTO updateProductionRequest(Long id, ProductionRequestDetailDTO dto) {
        ...
        integratedService.recentActivitySave(
                RecentActivityEntryDTO.create(
                        updatedEntity.getName() + " 생산의뢰 정보 변경",
